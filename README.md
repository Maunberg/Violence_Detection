...
|--------------|----------|----------|---------|--------|
| **🎯 Мультимодальная** | **85.87%** | **85.47%** | **85.82%** | ✅ Лучшая |
| Все компоненты | 83.70% | 83.63% | 87.86% | ✅ Работает |
| Только аудио | - | - | - | ⚠️ Ошибка ключей |
| Только видео | - | - | - | ⚠️ Ошибка ключей |

**Вывод**: Мультимодальный подход показывает наилучшие результаты, подтверждая важность комбинации аудио и визуальных признаков.
